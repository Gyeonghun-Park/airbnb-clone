# Generated by Django 3.0.5 on 2020-05-01 03:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='language',
            field=models.CharField(blank=True, choices=[('en', 'English'), ('fr', 'French'), ('kr', 'Korean')], default='kr', max_length=2, verbose_name='language'),
        ),
    ]
